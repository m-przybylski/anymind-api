...
import { PostProfileDetails } from '../model/postProfileDetails';
import { PostProfileWithInvoiceDetails } from '../model/postProfileWithInvoiceDetails';
...
export class ProfileService {
     ...
     * Create profile
     * 
     * @param body Profile and invoice details
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public postCreateProfileWithInvoiceDetailsRoute(body: PostProfileWithInvoiceDetails, observe?: 'body', reportProgress?: boolean): Observable<GetProfile>;
    public postCreateProfileWithInvoiceDetailsRoute(body: PostProfileWithInvoiceDetails, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetProfile>>;
    public postCreateProfileWithInvoiceDetailsRoute(body: PostProfileWithInvoiceDetails, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetProfile>>;
    public postCreateProfileWithInvoiceDetailsRoute(body: PostProfileWithInvoiceDetails, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling postCreateProfileWithInvoiceDetailsRoute.');
        }
        ...
        return this.httpClient.post<GetProfile>(`${this.basePath}/api/profiles`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postProfileValidateRoute(body: PostProfileDetails, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public postProfileValidateRoute(body: PostProfileDetails, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public postProfileValidateRoute(body: PostProfileDetails, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public postProfileValidateRoute(body: PostProfileDetails, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling postProfileValidateRoute.');
        }
        ...
        return this.httpClient.post<any>(`${this.basePath}/api/profiles/validate`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
