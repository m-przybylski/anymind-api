...
export class AdminpanelService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPartnerInvoicesRoute(limit: string, offset: string, observe?: 'body', reportProgress?: boolean): Observable<Array<GetInvoice>>;
    public getPartnerInvoicesRoute(limit: string, offset: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<GetInvoice>>>;
    public getPartnerInvoicesRoute(limit: string, offset: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<GetInvoice>>>;
    public getPartnerInvoicesRoute(limit: string, offset: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (limit === null || limit === undefined) {
            throw new Error('Required parameter limit was null or undefined when calling getPartnerInvoicesRoute.');
        }
        if (offset === null || offset === undefined) {
            throw new Error('Required parameter offset was null or undefined when calling getPartnerInvoicesRoute.');
        }
        ...
        return this.httpClient.get<Array<GetInvoice>>(`${this.basePath}/api/adminpanel/invoices`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postAccountRoute1(body: PostAdminPanelAccount, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public postAccountRoute1(body: PostAdminPanelAccount, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public postAccountRoute1(body: PostAdminPanelAccount, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public postAccountRoute1(body: PostAdminPanelAccount, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling postAccountRoute1.');
        }
