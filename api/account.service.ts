...
export class AccountService {
     ...
     */
    public addAccountRoute(body: AddAccount, observe?: 'body', reportProgress?: boolean): Observable<Account>;
    public addAccountRoute(body: AddAccount, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Account>>;
    public addAccountRoute(body: AddAccount, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Account>>;
    public addAccountRoute(body: AddAccount, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
