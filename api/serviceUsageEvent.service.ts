...
import { PostExpertRejectComplaint } from '../model/postExpertRejectComplaint';
...
export class ServiceUsageEventService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postExpertRejectComplaintRoute(sueId: string, body: PostExpertRejectComplaint, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public postExpertRejectComplaintRoute(sueId: string, body: PostExpertRejectComplaint, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public postExpertRejectComplaintRoute(sueId: string, body: PostExpertRejectComplaint, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public postExpertRejectComplaintRoute(sueId: string, body: PostExpertRejectComplaint, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (sueId === null || sueId === undefined) {
            throw new Error('Required parameter sueId was null or undefined when calling postExpertRejectComplaintRoute.');
        }
        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling postExpertRejectComplaintRoute.');
        }
