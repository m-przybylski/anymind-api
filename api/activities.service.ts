...
import { GetInvoiceUrl } from '../model/getInvoiceUrl';
...
export class ActivitiesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getInvoiceDownloadUrlRoute(invoiceId: string, observe?: 'body', reportProgress?: boolean): Observable<GetInvoiceUrl>;
    public getInvoiceDownloadUrlRoute(invoiceId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetInvoiceUrl>>;
    public getInvoiceDownloadUrlRoute(invoiceId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetInvoiceUrl>>;
    public getInvoiceDownloadUrlRoute(invoiceId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (invoiceId === null || invoiceId === undefined) {
            throw new Error('Required parameter invoiceId was null or undefined when calling getInvoiceDownloadUrlRoute.');
        }
        ...
        return this.httpClient.get<GetInvoiceUrl>(`${this.basePath}/api/activities/invoice/${encodeURIComponent(String(invoiceId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
