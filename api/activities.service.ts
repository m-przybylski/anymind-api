...
export class ActivitiesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getExpertProfileActivitiesRoute(observe?: 'body', reportProgress?: boolean): Observable<GetProfileActivities>;
    public getExpertProfileActivitiesRoute(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetProfileActivities>>;
    public getExpertProfileActivitiesRoute(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetProfileActivities>>;
    public getExpertProfileActivitiesRoute(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOrganizationProfileActivitiesRoute(observe?: 'body', reportProgress?: boolean): Observable<GetProfileActivities>;
    public getOrganizationProfileActivitiesRoute(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GetProfileActivities>>;
    public getOrganizationProfileActivitiesRoute(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GetProfileActivities>>;
    public getOrganizationProfileActivitiesRoute(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
