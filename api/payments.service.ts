...
export class PaymentsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postCreditCardRoute(body: PostAddNewCard, observe?: 'body', reportProgress?: boolean): Observable<Function1RequestContextFutureRouteResult>;
    public postCreditCardRoute(body: PostAddNewCard, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Function1RequestContextFutureRouteResult>>;
    public postCreditCardRoute(body: PostAddNewCard, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Function1RequestContextFutureRouteResult>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postTPayNotificationRoute(body: string, observe?: 'body', reportProgress?: boolean): Observable<Function1RequestContextFutureRouteResult>;
    public postTPayNotificationRoute(body: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Function1RequestContextFutureRouteResult>>;
    public postTPayNotificationRoute(body: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Function1RequestContextFutureRouteResult>>;
